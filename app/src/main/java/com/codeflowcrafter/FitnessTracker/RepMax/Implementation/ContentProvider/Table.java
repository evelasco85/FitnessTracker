...
public class Table extends BaseTable {
    public Table()
    {
        ...
        _search_projection_map.put(SearchManager.SUGGEST_COLUMN_TEXT_1, RepMax.COLUMN_START_DATE + " AS " + SearchManager.SUGGEST_COLUMN_TEXT_1);
        _search_projection_map.put("_id", RepMax.COLUMN_ID + " AS " + "_id");
    }

    public String GetRecordKeyColumnName()
    {
        return RepMax.COLUMN_ID;
    }

    public String GetTableName()
    {
        return RepMax.TABLE_NAME;
    }

    public String GetProviderName(){ return RepMax.PROVIDER_NAME; }

    public String GetTableCreationScript()
    {
        HashMap<String, String> tableColumns = RepMax.GetTableColumns();
        ...
        return "create table " + RepMax.TABLE_NAME + " ( " +
    ...
    public SQLiteQueryBuilder GetQueryBuilder(Uri uri)
    {
        ...
        switch (GetUriMatcher().match(uri))
        {
            ...
            case ContentProviderTemplate.URI_SEARCH_GLOBAL:
                queryBuilder.appendWhere(RepMax.COLUMN_START_DATE + " LIKE \"% " + uri.getPathSegments().get(1) + "%\"");
